...
#import "BSCTabBarBadge.h"

@interface BSCTabBarItem ()

@property (nonatomic, strong) BSCTabBarBadge *tabBarBadge;

@end

@implementation BSCTabBarItem
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.tabBarBadge = [[BSCTabBarBadge alloc] init];
